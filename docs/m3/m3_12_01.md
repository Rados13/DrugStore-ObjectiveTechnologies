...
| :-------------------------------------------------      | :------------------------------------------------------- | :----------------------------------------------------------- | :---------------------------------------------------------------- |
| Poprawa interfejsów, dodanie nowych klas abstrakcyjnych | Dodanie klas GUI wyświetlające użytkowników i lekarstwa  | Uzupełnienie modelu o dostawców i zamówienia                 | Stworzenie GUI dla wyświetlania statystyk                                  |
| Dodanie marginesów w aplikacji                          | Dodanie okna logowania i rejestracji użytkowników        | Dodanie brakujących DAO oraz refaktoryzacja już istniejących | Stworzenie części kodu odpowiedzialnej za wyliczanie statystyk   |
| Zmiany w widokach ułatwiające korzystanie z aplikacji   | Dodanie panelu administracyjnego                         | Dodanie do dokumentacji przykładowych widoków GUI            | Uzupełnienie dokumentacji o screeny                   |
|                                                         |                                                          |                                                              |                                                                   | 
