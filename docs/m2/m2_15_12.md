...
| :-------------------------------------------------  | :------------------------------------------------------- | :---------------------------------- | :---------------------------------------------------------------- |
| Autoryzacja logowania                               | Dodanie klas GUI wyświetlające użytkowników i lekarstwa  | Stworzenie początkowych klas modeli | Stworzenie GUI dla ClientOrder                                    |
| Fragment GUI do zarządzania dostawcami              | Dodanie okna logowania i rejestracji użytkowników        | Praca nad modelem                   | Stworzenie abstrakcyjnych klas dla implementacji wzorca command   |
| Dokumentacja i zmiany w schemacie uml modelu danych | Dodanie panelu administracyjnego                         |                                     | Dodanie do dokumentacji opisów fragmentów GUI                     |
| Refaktoryzacja kodu                                 |                                                          |                                     |                                                                   | 
