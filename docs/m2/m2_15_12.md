...
| Dokumentacja i zmiany w schemacie uml modelu danych | Dodanie panelu administracyjnego                         | Dodanie do dokumentacji przykładowych widoków GIU            | Dodanie do dokumentacji opisów fragmentów GUI                     |
