...
Dodatkowo dodaliśmy wzorzec command w celu zarządzania operacjami w GUI.

#### Kto co wykonał w tym millestonie

| Wiktor                                              | Przemysław                                                  | Paweł                               | Radosław                                                          |
| :-------------------------------------------------  | :---------------------------------------------------------- | :---------------------------------- | :---------------------------------------------------------------- |
| Autoryzacja logowania                               | Wyszukanie możliwych miejsc na hosting bazy danych          | Stworzenie początkowych klas modeli | Stworzenie GUI dla ClientOrder                   |
| Fragment GUI do zarządzania dostawcami              | Stworzenie bazy danych na portalu heroku.com i konfiguracja | Praca nad modelem                   | Stworzenie abstrakcyjnych klas dla implementacji wzorca command |
| Dokumentacja i zmiany w schemacie uml modelu danych | Praca nad modelem                                           |                                     | Dodanie do dokumentacji opisów fragmentów GUI                |
| Refaktoryzacja kodu                                 | Dodanie GUI                                             |                                     |                                     |

#### Opis fragmentów GUI

##### Główne okno aplikacji 
 
Klasa AppController odpowiada za główne okno aplikacji. Początkowo pojawia się okno do wprowadzenia danych.
Przykładowy użytkownik administratora na którego dane można się zalogować.
...
Za to okno odpowiada klasa ClientOrderOverviewController, 
gdzie klasa ClientOrderAppController odpowiada za jej odpowiednią inicjalizację.
W tym oknie wyświetla się lista zamówień klientów. Mamy możliwość:
...
Po naciśnięciu przycisku odpowiadającego za dodanie zamówienia 
lub modyfikacji wybranego zamówienia wyświetla się nam nowe okno.
Za to okno odpowiada klasa ClientOrderEditDialogPresenter.
W tym oknie możemy:
...
Za to okno odpowiada klasa MedicationOverviewController, 
gdzie klasa MedicationAppController odpowiada za jej odpowiednią inicjalizację.
W tym oknie wyświetla się lista leków w bazie apteki. Mamy możliwość:
...
Po naciśnięciu przycisku odpowiadającego za dodanie leku 
lub modyfikacji wybranego leku wyświetla się nam nowe okno.
Za to okno odpowiada klasa MedicationEditDialogPresenter.
W tym oknie możemy:
...
Za to okno odpowiada klasa PersonOverviewController, 
gdzie klasa PersonAppController odpowiada za jej odpowiednią inicjalizację.
W tym oknie wyświetla się lista osób w bazie apteki. Mamy możliwość:
...
Po naciśnięciu przycisku odpowiadającego za dodanie osoby 
lub modyfikacji danych wybranej osoby  wyświetla się nam nowe okno.
Za to okno odpowiada klasa PersonEditDialogPresenter.
W tym oknie możemy:
...
Za to okno odpowiada klasa SupplierOverviewController, 
gdzie klasa SupplierAppController odpowiada za jej odpowiednią inicjalizację.
W tym oknie wyświetla się lista leków w bazie apteki. Mamy możliwość:
...
Po naciśnięciu przycisku odpowiadającego za dodanie dostawcy
lub modyfikacji wybranego dostawcy wyświetla się nam nowe okno.
Za to okno odpowiada klasa SupplierEditDialogPresenter.
W tym oknie możemy:
