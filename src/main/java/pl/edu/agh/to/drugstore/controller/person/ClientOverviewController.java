...
@Setter
public class ClientOverviewController extends OverviewController<Person> {
    ...
    private ClientAppController personAppController;
    ...
    public void setAppController(ClientAppController personAppController) {
